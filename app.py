...
# -------------------------------------------------------------------
# TRADINGVIEW CHART (Mit intelligentem Elite-Filter)
# -------------------------------------------------------------------
def get_tradingview_widget(ticker, strat, current_watchlist_name):
    ...
    # Wenn "Elite 7" ausgewählt ist, lade den EMA für die 200-Tage-Strategie
    if "Elite 7" in current_watchlist_name:
        studies = ["MAExp@tv-basicstudies"]
    # Bei Momentum-Swing lade MACD
...
# Übergabe des aktuellen Watchlist-Namens an den Chart
components.html(get_tradingview_widget(st.session_state.selected_ticker, strategy, wl_name), height=490, scrolling=False)
